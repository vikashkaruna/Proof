...
through 0028. Nothing has been deployed, no evidence bucket is locked and no action
...
current checkpoint, then [Doc 14 implementation progress](14_Implementation_Progress.md)
