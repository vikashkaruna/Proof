...
Vault foundation acceptance is covered by SQL/crypto/adapter tests; the existing browser/API parity suite does not acquire client tokens or exercise cloud KMS. Real KMS acceptance and the future OAuth broker require separate evidence (Doc 16 W4-2).
