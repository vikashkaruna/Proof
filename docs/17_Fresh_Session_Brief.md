# Continuing implementation — Revision 87

**Current status board:** see [Doc 14 — Build status board (Revision 87)](14_Implementation_Progress.md#build-status-board--revision-87-2026-09-25). It lists each stream's status, pending work, effort (S/M/L/XL) and outside gates.
