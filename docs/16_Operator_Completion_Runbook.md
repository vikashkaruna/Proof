...
| C-W1-3 | **Delivered, Rev 78.** Invitation workflow (0053), audited RPCs, BFF/web UI and mail adapter contract; real delivery remains gated on W1-2 provider/domain evidence |
...
| C-W3-5 | Complete resumable company → estate → inventory → connector/grant → readiness wizard — delivered (Rev 79)  |
| C-W3-6 | Re-onboarding/sustenance and access re-attestation — delivered (Rev 80); scheduled checks remain W6        |
