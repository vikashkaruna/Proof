...
Committed as `a6bb4df` on branch `claude/axiom-proof-phase-gap-closure-b88105`, merged to staging. Integrated staging `ad2d046`; its upstream CI was green. Migration allocation moves to **0030** — allocated after re-fetching staging, which had not moved past `ad2d046`.
