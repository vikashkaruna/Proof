/** Route-level loading state: the shape of the monitoring surface, honestly empty. */
export default function MonitoringLoading() {
  return (
    <div className="flex animate-pulse flex-col gap-6" aria-busy="true" aria-live="polite">
      ...
      <div className="h-56 rounded-xl border border-slate-200 bg-mist-50" />
      <div className="h-56 rounded-xl border border-slate-200 bg-mist-50" />
      <span className="sr-only">Loading monitoring records</span>
    </div>
  );
}
