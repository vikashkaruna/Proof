/** Route-level loading state: the shape of the execution surface, honestly empty. */
  ...
  return (
    <div className="flex animate-pulse flex-col gap-6" aria-busy="true" aria-live="polite">
      <div className="flex flex-col gap-3 border-b border-slate-200 pb-6">
        <div className="h-7 w-64 rounded bg-mist-100" />
      ...
      <div className="h-64 rounded-xl border border-slate-200 bg-mist-50" />
      <span className="sr-only">Loading execution records</span>
    </div>
  );
}
