...
Revision 59 adds [offline SPIRE configuration and admission preparation](../../../workload/README.md), including real local separate-host restart/image-selector acceptance. Host installation, persistent mount guards and issuer-sync health are still pending; this module remains default-off.
